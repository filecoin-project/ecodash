    ...
    <div class="grid">
      ...
      <div class="col-6_md-10_mi-12" data-push-left="off-1_md-0">
        ...
        <component
          ...
          :mobile="moreThanTwo"
          :slider="slider"
          :class="{ 'video-top' : pageTopRightComponent === 'SingularVideo' }" />
    ...
    <div class="grid">
      <div class="col-5_mi-10_mi-12">
        ...
        <component
          ...
          :mobile="moreThanTwo"
          :slider="slider"
          :class="{ 'stats-bottom' : pageBottomLeftComponent === 'SingularStats' }" />
...
import SingularStats from '@/components/SingularStats'
import SingularVideo from '@/components/SingularVideo'
...
export default {
  ...
  computed: {
    ...
    pageTopRightComponent () {
      return this.swapVideoPositionSingular ? 'SingularVideo' : 'SingularStats'
    },
    pageBottomLeftComponent () {
      return this.swapVideoPositionSingular ? 'SingularStats' : 'SingularVideo'
    },
    moreThanTwo () {
      let amt = 0
  ...
  methods: {
    ...
    stripProtocol (text) {
      return text.substring(0, 2) === '\/\/' ? text.substring(2) : text // eslint-disable-line
    }
  }
}
</script>
