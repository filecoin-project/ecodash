      ...
      <div id="paginated-list">
        ...
        <div
          ...
          <Controls
            ...
            <template #first-page>
              <FirstArrowIcon class="first-arrow" />
            </template>
            <template #prev-page>
              <PrevArrowIcon class="prev-arrow" />
            </template>
            <template #next-page>
              <NextArrowIcon class="next-arrow" />
            </template>
            <template #last-page>
...
import ProjectExplorerToolbar from '@/components/ProjectExplorerToolbar'
